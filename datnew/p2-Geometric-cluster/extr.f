      ...
      open(128,file='ext.Pbh', access='append')  
      open(129,file='ext.Pbh_2', access='append')  
...
!     dk = 0.0000002d0
 ...
 123  format(i5,2e22.12,f12.5)
      ...
      write(128,101) li,res(16)-res(27),err(16),zL,kp,swm,id2,nr
      write(129,101) li,res(28)-1+res(36),sqrt(err(28)**2+err(36)**2)
     & ,zL,kp,swm,id2,nr
