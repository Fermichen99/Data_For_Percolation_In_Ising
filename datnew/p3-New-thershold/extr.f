      ...
      open(19,file='ext.Pb1', access='append')  
      open(20,file='ext.CK1', access='append')  
...
!     dk = 0.0000002d0
 ...
 123  format(i5,2e22.12,f12.5)
      ...
      write(19,101) li,res(18),err(18),zL,kp,swm,id2,nr
      write(20,101) li,res(39),err(39),zL,kp,swm,id2,nr
      ...
      write(109,101) li,res(40),err(40),zL,kp,swm,id2,nr
      ...
      write(124,101) li,res(34),err(34),zL,kp,swm,id2,nr
      ...
      write(128,101) li,res(41),err(41),zL,kp,swm,id2,nr
